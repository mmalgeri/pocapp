...
import module namespace oa = "http://marklogic.com/ns/oauth" at "/application/models/oauth.xqy";
...
declare variable $service-document :=
      <oa:service-provider realm="http://twitter.com">
       ...
       <oa:authentication>
         <oa:consumer-key>eBLKl6t8rrWjUbvLL82RuVpGq</oa:consumer-key>
         <oa:consumer-key-secret>It7Wxh0ZnNzBRBWggmS7oCO63AXa2deVVojkMcxGvDT6j3xg3h</oa:consumer-key-secret>
       </oa:authentication>
      </oa:service-provider>;

  declare variable $access-token := "250775601-moYyYcYEmgc2V6lvYAY8NvpZtGPRD7SQOOsTHU4q"; (: YOUR USER'S APP ACCESS TOKEN :)
  declare variable $access-token-secret := "ZkY8TS9Qp86OKRkecfBCL3npIYBqTZ5DhrzsCNOJIePLz"; (: YOUR USER'S APP ACCESS TOKEN SECRET :)

  declare variable $options
    := <oa:options>
       <screen_name>mmalgeri</screen_name>
       <count>100</count>
       <page>1</page>
     </oa:options>;
