...
import module namespace te="http://marklogic.com/libs/temporal" at "/application/models/lib-temporal.xqy";
...
import module namespace oauth2 = "oauth2" at "/application/models/oauth2.xqy";

declare namespace jb = "http://marklogic.com/xdmp/json/basic";


(: collector libraries :)
import module namespace tw = "http://marklogic.com/roxy/twitter" at "/application/models/lib-twitter.xqy";
